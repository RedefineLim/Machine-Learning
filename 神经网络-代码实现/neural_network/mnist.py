...
x_test = test_data[:num_training_examples,1:]
y_test = test_data[:num_training_examples,[0]]
...
multilayer_perceptron = multilayer_perceptron = MultilayerPerceptron(x_train, y_train, layers, normalize_data)      #实例化操作
