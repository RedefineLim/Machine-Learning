...
class LogisticRegression:
    def __init__(self, data, labels, polynomial_degree=0, sinusoid_degree=0, normalize_data=False):
        ...
        '''
        (data_processed,
         features_mean, features_deviation) = prepare_for_training(data, polynomial_degree, sinusoid_degree, normalize_data=False)
    ...
    def train(self,max_iterations=1000):
        ...
        for label_index,unique_label in enumerate(self.unique_labels):
            current_initial_theta = (self.theta[label_index].reshape(num_features,1))
    ...
    def cost_function(data,labels,theta):
        ...
        cost = (-1/num_examples)*(y_is_set_cost + y_is_not_cost)
        return cost
